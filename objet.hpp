...
public:
	...
	Objet(Color aColor) :couleurObjet(aColor),brillance(-1),reflechissance(-1){}
	Objet(Color aColor,double brille,double reflech) :couleurObjet(aColor),brillance(brille),reflechissance(reflech){}
