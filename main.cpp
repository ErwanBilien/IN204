...
int main() {
    ...
    Color marronClair(0.77,0.38,0.06);
    ...
    std::vector<Lumiere*> listeLumiere;
        ...
        Sphere sphere_2(0.4,float3(1,1.75,-0.5),vert,verre_1);
        Sphere sphere_3(0.25, float3(0.75,1.75,0.5), Color(0, 1, 0),metal_1);
        Sphere sphere_4(5000,float3(0,-5001,0),jaune,1000,0.5);
        Sphere sphere_5(0.25,float3(3,1,4),blanc,plastique_1);
        Plan plan_1(float3(1,-1,0),float3(0,-1,0),float3(0,-1,1),marronClair,plastique_1);
        ...
        Tetraedre tetra_1(float3(1,0,-5),float3(1,0,1),float3(0,1,-1),float3(2,0,0),jaune,verre_1);
        Parallelepipede cube_1(float3(),float3(3,0,0),float3(0,1,0),float3(1,0,1),bleu,metal_1);

        //parallelepipede(origine , arrete1,arrete2,arrete3,couleur,materiau)
        Parallelepipede pieds1(float3(-2,-1,0),float3(1,0,0),float3(0,0,1),float3(0,2,0),marron,plastique_1);
        Parallelepipede pieds2(float3(1,-1,0),float3(1,0,0),float3(0,0,1),float3(0,2,0),marron,plastique_1);
        Parallelepipede table(float3(-2,1,-0.5),float3(4,0,0),float3(0,0,2),float3(0,0.5,0),marron,plastique_1);
        ...
        listeTri.push_back(Triangle(float3(3,0,4),float3(1,0,4.5),float3(3,3,4)));
        listeTri.push_back(Triangle(float3(1,0,4.5),float3(1,3,4.5),float3(3,3,4)));
        Solide solide_1(listeTri,blanc,mirroir);
        ...
        listeObjets.push_back(&solide_1);
    ...
    */
    //if(setup==2){
        ...
        Tetraedre tetra_1(float3(1,2,-2),float3(-1,2,1),float3(-2,2,-1),float3(-2,2,0),jaune,verre_1);
